...
function typeWriter() {
  if (i < txt1.length) {
    if (txt1.charAt(i) == "<")
      ...
      $(".bg_heart").css("background-image", ""); // Corrected this line
      askForAcceptance();
